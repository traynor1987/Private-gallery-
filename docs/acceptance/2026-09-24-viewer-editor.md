...
- Vault photo viewing also uses the bounded renderer and cancellable selected-item reader without changing zoom/pan gestures.
...
## Automated evidence
Android CI #302 on baba43a279a78cb77d462e11fe385a88600d7de2 passed unit tests, lint, both debug APK builds and 66/66 Android instrumentation tests. No tests skipped. This includes 14 new instrumentation cases and 13 additional JVM cases (210 total JVM tests). Synthetic inner portrait/landscape and outer landscape snapshots were visually inspected. The first outer-portrait ATD screenshot was blank despite passing layout assertions; capture is now primed before review snapshots. This is emulator evidence, not physical Fold acceptance.
