...
CI #306 on `252ff47e20d2f91030bb129dc56f8141f8bf917a` passed unit tests, lint, both debug APK builds and all 73 emulator tests. This includes 15 new JVM tests and 7 new instrumentation cases. Security review found one cancellation-result handoff cleanup race, fixed and covered by a deterministic regression. This is automated/fake-provider evidence, not live API or physical-device acceptance.
