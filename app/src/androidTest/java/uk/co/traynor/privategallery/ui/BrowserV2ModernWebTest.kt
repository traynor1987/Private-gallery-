...
class BrowserV2ModernWebTest {
    ...
    private fun load(body: String) {
        compose.runOnIdle { session.activeWebView().loadDataWithBaseURL("https://fixture.invalid/", "<!doctype html><meta name='viewport' content='width=device-width,initial-scale=1'>$body", "text/html", "UTF-8", null) }
        compose.waitUntil(15_000) { js("document.readyState") == "\"complete\"" && js("document.body !== null") == "true" }
    }
